...
$text1 .= "
	...
	<tr>
        ...
        $text1 .= "
		<b>
		<a style='cursor:hand; text-decoration:none' href='admin_new.php'>>> Add MIA User <<</a></b>";
        } else {
        $text1 .= "
        <a style='cursor:hand; text-decoration:none' href='admin_new.php'>Add MIA User</a>";}
...
$text1 .= "
<b><a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_edit.php'>>> Edit MIA Users <<</a></b>";
} else {
 $text1 .="
<a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_edit.php'>Edit MIA Users</a>";}
